                ...
                <section className="portone-default whoami">
                    <div className="whoami__inner">
                        ...
                        <p className="whoami__floater">
                            I chose frontend web developement ever since
                            university, and stuck with that since. I love and
                            hate the React, Redux, webpack stack, but I also had
                            the chance to love and curse other things, too.
                        </p>
